...
_MESSAGES = {
    "it": {
        ...
        "timer.missing_label": "Un timer cosa?",
        "timer.set": "Timer '{label}' impostato per {duration}.",
        "timer.completed": "Timer {label} completato.",
        "timer.none_active": "Non ci sono timer attivi.",
        "timer.status_header": "Timer attivi: {timers}.",
        "timer.status_item": "{label}: mancano {duration}",
        ...
        "event.invalid_action": "Azione '{action}' non riconosciuta. Usa: set, list, delete.",
        "event.missing_title": "Errore: serve un titolo per il promemoria.",
        "event.missing_due_at": "Errore: specifica quando devo ricordartelo.",
        "event.invalid_due_at": "Errore: data o ora del promemoria non valida.",
        "event.past_due_at": "Errore: il promemoria deve essere nel futuro.",
        "event.set": "Promemoria '{title}' impostato per {due_at}.",
        "event.completed": "Promemoria {title}.",
        "event.none_active": "Non ci sono promemoria attivi.",
        "event.list_header": "Promemoria attivi: {events}.",
        "event.list_item": "{title} ({id}): {due_at}",
        "event.delete_missing_id": "Errore: specifica l'id del promemoria da eliminare.",
        "event.delete_not_found": "Promemoria non trovato o non attivo.",
        "event.deleted": "Promemoria eliminato.",
    ...
    "en": {
        ...
        "timer.missing_label": "A timer for what?",
        "timer.set": "Timer '{label}' set for {duration}.",
        "timer.completed": "Timer {label} completed.",
        "timer.none_active": "There are no active timers.",
        "timer.status_header": "Active timers: {timers}.",
        "timer.status_item": "{label}: {duration} remaining",
        ...
        "event.invalid_action": "Action '{action}' is not recognized. Use: set, list, delete.",
        "event.missing_title": "Error: reminder title is required.",
        "event.missing_due_at": "Error: specify when I should remind you.",
        "event.invalid_due_at": "Error: invalid reminder date or time.",
        "event.past_due_at": "Error: reminder time must be in the future.",
        "event.set": "Reminder '{title}' set for {due_at}.",
        "event.completed": "Reminder {title}.",
        "event.none_active": "There are no active reminders.",
        "event.list_header": "Active reminders: {events}.",
        "event.list_item": "{title} ({id}): {due_at}",
        "event.delete_missing_id": "Error: specify the reminder id to delete.",
        "event.delete_not_found": "Reminder not found or not active.",
        "event.deleted": "Reminder deleted.",
